...
var bbbfly=bbbfly||{};bbbfly.morph=bbbfly.morph||{};bbbfly.morph.hint={};bbbfly.morph.hint._doUpdate=function(a){if(!this.DoUpdate.callParent(a))return!1;a instanceof HTMLElement&&(String.isString(this.HintType)?a.setAttribute("type",this.HintType):a.removeAttribute("type"));return!0};
